...
def turn_off():
    ...
    # здесь должна быть ачивка. наверно.
...
def chapter_4():
    ...
    print("Вы покидаете зловещий госпиталь, рядом с вами идет ребенок, \nсзади несколько роботов из группы Омега.")
...
def chapter_5_main():
    ...
    print("Дверь за вами с шумом закрывается, вы оказываетесь заперты.")
